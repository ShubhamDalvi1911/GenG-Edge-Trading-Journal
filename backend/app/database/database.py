...
ACCOUNT_UPGRADE_COLUMNS = {
    ...
    "users.avatar_zoom": "INTEGER DEFAULT 100",
    "users.avatar_position": "VARCHAR DEFAULT 'center'",
    ...
    "maximum_position_size": "NUMERIC(20,8)",
    "leverage": "NUMERIC(12,6)",
    "daily_profit_target": "NUMERIC(20,8)",
    "consistency_rule_enabled": "BOOLEAN DEFAULT FALSE",
    "consistency_max_best_day_percent": "NUMERIC(20,8)",
    ...
    "trailing_drawdown_value": "NUMERIC(20,8)",
}
